							...
							<div class="card o-visible">
								...
								<div class="card-block">
									...
									<div class="card-block d-flex justify-content-center align-items-center"
										style="height: 140px;">
										<a href="<?= base_url('admin/customer_address/view/' . $add_CustId); ?>"
							...
							<div class="col-xl-4">
								...
								<div class="card o-visible">
									...
									<div class="card-block">
										...
										<a
											href="<?= base_url('admin/customer_address/view/' . esc($rows['cust_Id']) . '/' . esc($rows['add_Id'])); ?>">
											<i class="bi bi-pencil-square"></i></a>
										<i class="icofont icofont-bag-alt"></i></span></a>&nbsp;&nbsp; | &nbsp;&nbsp;
										<i class="bi bi-trash text-danger icon-clickable"
											onclick="confirmDelete(<?= $rows['add_Id']; ?>)"></i>
									</div>
								</div>
