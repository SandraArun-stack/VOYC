        ...
        <nav class="pcoded-navbar">
            ...
            <div class="pcoded-inner-navbar main-menu">
                ...
                <ul class="pcoded-item pcoded-left-item">
                    ...
                    <li class="pcoded-hasmenu <?= in_array($segment, ['leaderboard','games','players','subscription','usersubscriptions','wallet','daily_counter','transactions']) ? 'active pcoded-trigger' : '' ?>">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="<?= ($segment == 'daily_counter') ? 'active' : '' ?>">
                                <a href="<?= base_url('admin/daily_counter') ?>">
