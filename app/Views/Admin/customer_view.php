                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a
                                href="#"><?= isset($cust) ? 'Update Customer' : 'Add Customer'; ?></a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <form name="createcust" id="createcust" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="custname" id="custname" class="form-control"
                                                    maxlength="30"
                                                    value="<?= isset($cust) ? ($cust['cust_Name']) : '' ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="email" class="form-control" name="custemail" id="custemail"
                                                    maxlength="30"
                                                    value="<?= isset($cust) ? ($cust['cust_Email']) : '' ?>"
                                        ...
                                        <div class="row justify-content-center">
                                            <input type="hidden" name="cust_id"
                                                value="<?= isset($cust['cust_Id']) ? esc($cust['cust_Id']) : '' ?>">
                                            <div class="button-group">
                                                <button type="button" class="btn btn-secondary"
                                                    onclick="window.location.href='<?= base_url('admin/customer'); ?>'">
                                                    <i class="bi bi-x-circle"></i> Discard
                                                </button>
                                                <button type="button" class="btn btn-primary" id="custSubmit"
                                                    name="custSubmit">
