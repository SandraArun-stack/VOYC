...
class AllCustProductModel extends Model
{
    ...
    public function getAllCustomProducts($perPage = 18)
    {
        $builder = $this->select('product.*, product_image.pri_Thumbnail, product_image.pri_Status, product_image.pri_Id')
