        ...
        try {
            ...
            <h2 style="color:#d81b60;">Order Confirmed!</h2>
                <p style="font-size:15px; color:#444;">
                    ...
                    We’re excited to let you know that your order has been successfully placed with <strong>VOYC</strong>! 🎉<br>
            ...
            $mail->AltBody = "Thank you for your order from VOYC. Order ID: {$od_Id}. Product: {$product->pr_Name}, Quantity: {$order->od_Quantity}. Total: ₹{$order->od_Grand_Total}.";
            $mail->send();
